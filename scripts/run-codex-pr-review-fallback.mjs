...
function buildCodexFallbackReviewPrompt({ context, prDiff }) {
  return [
    ...
    "}",
    'If there are no major issues, set criticalFindings to ["重大 blocker は見つかりませんでした。"], risks to ["人間は revision GO または merge GO + real passkey の前に PR を確認してください。"], and recommendedAction to "approve".',
    'If the provided diff or context is insufficient for critique, set recommendedAction to "manual_review" and explain exactly what is missing in Japanese.',
    "",
    "PR context:",
    context,
    "",
