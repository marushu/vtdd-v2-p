...
test("E2E-31 evidence doc records PR mergeability preflight runs and live-E2E blocker", () => {
  ...
  assert.equal(doc.includes("test/e2e-31-live-pr-mergeability-preflight.test.js"), true);
  assert.equal(doc.includes("It does not create branches, update PRs,"), true);
});
