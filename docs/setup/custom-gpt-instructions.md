...
- When VPS root/sudo maintenance is needed, call vtddCreateVpsMaintenanceProposal first. It returns a scoped passkey operator URL and owner-facing proposal truth; it must not be treated as root execution or permission to run the helper.
