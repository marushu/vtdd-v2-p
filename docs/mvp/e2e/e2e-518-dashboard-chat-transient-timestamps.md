...
- confirm long-running progress has an inline transient progress pane path that updates
...
- confirms `transient_status` also has an inline transient progress pane path for
...
mapping, inline transient progress routing, and final connected-state reset.
